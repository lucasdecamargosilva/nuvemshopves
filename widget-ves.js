(function () {
    ...
    (function() {
        function injectPLBadge() {
            try {
                ...
                a.href = 'https://provoulevou.com.br?utm_source=widget&utm_medium=lojista&utm_campaign=ves';
                a.target = '_blank';
                a.rel = 'noopener';
    ...
    // ===============================================
    const apiKey = "pl_live_feb43f51e24bed7cda7a51c0986acedd09871c5c9bcef13e1c5abea20b9f8d86";
    window.PROVOU_LEVOU_API_KEY = apiKey;

    const WEBHOOK_PROVA = 'https://n8n.segredosdodrop.com/webhook/gerador-oculos';
    const WEBHOOK_PIX = 'https://n8n.segredosdodrop.com/webhook/ves-pix';
    const WEBHOOK_PIX_STATUS = 'https://n8n.segredosdodrop.com/webhook/ves-pix-status';
    const WEBHOOK_CHECK_LIMIT = 'https://n8n.segredosdodrop.com/webhook/ves-check-limit';
...
/* PL: borda arredondada do modal */@media(min-width:768px){.q-card-ia,.q-card,#q-card-ia,#q-card,.q-modal-card{border-radius:16px !important;overflow:hidden;}}
        ...
        .q-btn-trigger-ia {
            position: absolute; top: 16px; right: 14px; z-index: 100;
        ...
        .q-btn-inline-provador {
            ...
            border: 1.5px solid var(--c-ink); border-radius: 40px;
            font-family: 'Instrument Sans', var(--font-body), sans-serif; font-size: 13px; font-weight: 700; letter-spacing: 2px; text-transform: uppercase;
            ...
            <div class="q-card-ia">
                ...
                <div class="q-content-scroll">
                    ...
                    <div id="q-header-provador">
                        ...
                        <img src="https://acdn-us.mitiendanube.com/stores/005/170/064/themes/common/logo-112272651-1746557529-8ef02f37c0dfb87f3657f12fc8f71b311746557530-480-0.webp" alt="VES" style="height:48px;width:auto;"/>
                    </div>
                    ...
                    <div id="q-loading-box">
                        <div class="q-loading-texts">
                            ...
                            <a href="https://provoulevou.com.br?utm_source=widget&utm_medium=lojista&utm_campaign=ves" target="_blank" class="q-loading-t2">
                ...
                <a href="https://provoulevou.com.br?utm_source=widget&utm_medium=lojista&utm_campaign=ves" target="_blank" class="q-powered-footer">
                    <span>Powered by</span>
            ...
            try {
                ...
                if (pending) {
                    ...
                    const resp = await fetch(WEBHOOK_PIX, {
                        method: 'POST',
                        headers: { 'Content-Type': 'application/json' },
                        body: JSON.stringify({ email: 'cliente@provoulevou.com.br', phone, loja: 'ves', origin: location.origin })
                    });
                    pix = await resp.json();
